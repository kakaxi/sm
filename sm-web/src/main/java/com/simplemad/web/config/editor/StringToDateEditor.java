...
public class StringToDateEditor extends SimplemadPropertyEditor {

	private final boolean allowEmpty;

	private final int exactDateLength;

	public StringToDateEditor() {
	 ...
	 */
	public StringToDateEditor(boolean allowEmpty) {
	 ...
	 */
	public StringToDateEditor(boolean allowEmpty, int exactDateLength) {
		this.allowEmpty = allowEmpty;
	...
	public void setAsText(String text) throws IllegalArgumentException {
		if (this.allowEmpty && !StringUtils.hasText(text)) {
			...
			setValue(DateUtil.translateToDate(text, DateUtil.FULL_PATTERN));
		}
	}
	...
	public String getAsText() {
		...
		return (value != null ? DateUtil.translateToString(value, DateUtil.FULL_PATTERN) : "");
	}
	@Override
