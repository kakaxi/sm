...
<script type="text/javascript">
	...
	function complete() {
		...
		$.post("${path}/moneyexchange/complete.do", {recordId : selectedRecordId}, function(data) {
			if(eval(data)) {
				alert("完成充值记录成功");
				window.location = "${path}/moneyexchange/findProcessedRecords.do";
			} else {
				alert("完成充值记录失败,请重试");
			}
		});
...
<body>
	<input type="button" value="完成充值" onclick="complete()"/>
	<table>
